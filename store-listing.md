...
A study tool for Korean learners. Highlight hanja, hanzi, or kanji to read them in Korean, or highlight a Korean (hangul) word to see its hanja.
...
The whole dictionary ships inside the extension. Okpyeon makes no network requests, collects no data, and works with no internet connection.
